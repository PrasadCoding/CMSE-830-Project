...
ax.barh([category], [bmi], color=color, height=0.1)  # Adjust bar height for better fit
ax.set_xlim(0, 40)
ax.set_xlabel("BMI Value")
ax.tick_params(axis='y', labelsize=6)  # Smaller font size for the y-axis labels
ax.tick_params(axis='x', labelsize=6)  # Smaller font size for the x-axis labels
