...
# Add title and subtitle with improved styling using the color palette
st.markdown(
    """
    <style>
    .title {
        color: #C9CED1;  /* Silver color for visibility */
        font-size: 50px;
        font-weight: bold;
        text-align: center;
    ...
    .subtitle {
        color: #E3CBC3;  /* Pale Dogwood color for a softer subtitle */
        font-size: 24px;
        text-align: center;
    ...
    .content {
        color: #E3CBC3;  /* Pale Dogwood for description text to match soft background */
        font-size: 18px;
        text-align: center;
    ...
    .stButton > button {
        background-color: #E3CBC3;  /* Pale Dogwood button background */
        color: #ffffff;
        font-size: 18px;
        font-weight: bold;
        border-radius: 12px;
    ...
    .stButton > button:hover {
        background-color: #DBB5AA;  /* Darker Pale Dogwood on hover */
    }
    </style>
    """,
    unsafe_allow_html=True,
